        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehousemanId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillsOfSale_AspNetUsers_WarehousemanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unloaded = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentOrders_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillOfSaleId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GUID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LastShipment = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateOfStoring = table.Column<DateTime>(type: "datetime2", nullable: false),
                    WarehousemanId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LocationHistories_AspNetUsers_WarehousemanId",
                        column: x => x.WarehousemanId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LocationHistories_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillsOfSale_WarehousemanId",
                table: "BillsOfSale",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationHistories_InventoryId",
                table: "LocationHistories",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LocationHistories_WarehousemanId",
                table: "LocationHistories",
                column: "WarehousemanId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentOrders_ManagerId",
